    ...
    try:
        ...
        if torch.cuda.is_available():
            ...
            if memory_gb >= 8:
                ...
                print("GPU Memory: Limited, recommend batch_size=1")
            return True
        else:
            print("GPU: CUDA not available, will use CPU (slower)")
            return False
...
def check_openai_key():
    ...
    if os.getenv("OPENAI_API_KEY"):
        ...
        print("OpenAI API Key: Not set (required for data generation)")
        return False

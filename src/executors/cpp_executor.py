...
class CppExecutor:
    """Executes C++ code using g++ compilation."""
    ...
    def __init__(self, timeout_seconds: int = 10, max_memory_mb: int = 128):
        ...
        try:
            ...
            raise RuntimeError("C++ compiler (g++) is not installed or not in PATH")
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                compile_result = subprocess.run(
                    ['g++', '-std=c++17', '-O2', str(source_file), '-o', str(binary_file)],
                    capture_output=True,
                    text=True,
